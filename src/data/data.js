...
const QUESTION_DATA = [
    ...
    },
    {
      ...
      questions: [
          {
              question: <span>2 What does the woman suggest may be the reason for the man’s problem?</span>,
              answers: [
                <span>He is sitting in the wrong place</span>,
                <span>He is using the wrong bait</span>,
                <span>He has been waiting too long</span>,
  ...
  },
  {
    ...
    questions: [
        {
            question: <span>3 What does the woman suggest may be the reason for the man’s problem?</span>,
            answers: [
              <span>He is sitting in the wrong place</span>,
              <span>He is using the wrong bait</span>,
              <span>He has been waiting too long</span>,
